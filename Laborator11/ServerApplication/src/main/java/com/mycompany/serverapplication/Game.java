...
public class Game {
    ...
    private int initialTime; // Timpul inițial pentru fiecare jucător (în secunde)// Timpul rămas pentru jucătorul curent (în secunde)
    ...
    public boolean submitMove(Player currentPlayer, int row, int col, char mark, long currentTime) {

        
        long elapsedTime = currentTime - startTime;
        currentPlayer.setRemainingTime((int) (currentPlayer.getRemainingTime() - elapsedTime / 1000)); // Convertim milisecundele în secunde
